...
class Preset {
   ...
   * @param {MundusEnum} mundus - The key for the selected Mundus stone (e.g., MundusEnum.TheThief).
   * @param {MythicEnum} mythic - The key for the selected Mythic item (e.g., MythicEnum.VelothiUrMage).
